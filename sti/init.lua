...
function Map:drawObjectLayer(layer)
	...
	lg.setColor(reset)
	if layer._batches_dirty then
		-- Update batches somehow
		self:updateObjectLayerBatcher(layer)
		layer._batches_dirty = false
	end
...
function Map:updateObjectLayerBatcher(layer)
